...
export default function FormsPage() {
  ...
  return (
    <main className={styles.main} data-test='subscribe-form'>
      <h1 className={styles.header} data-test='form-header'>
        Testing Forms
      </h1>
      <ItemsAccordion items={items} />
      <TextField className={styles.input} label='Email' variant='filled' value={inputValue} onChange={(e) => setInputValue(e.target.value)} />
      <Button
